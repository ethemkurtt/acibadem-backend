...
const DigerTalepDetaySchema = new mongoose.Schema(
  {
    ...
    talep_tipi: { type: String, default: null },        // "Evrak" vb.
    talep_tipi_diger: { type: String,  default: null },
    alt_tip: { type: String,  default: null },           // "Banka" vb.
    alt_tip_diger: { type: String, default: null },
    talep_aciklama: { type: String,  default: null },
    nereden: { type: String,  default: null },
    nereye: { type: String,  default: null },
